                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              padding:
                                  EdgeInsets.only(top: 155.49.h, left: 10.83.w),
                              child: Text(
                                stepTexts[index],
                                style: TextStyle(
                                  fontSize: 16.24.sp,
                          ...
                          Align(
                            ...
                            child: Container(
                              padding:
                                  EdgeInsets.only(top: 207.89.h, left: 8.83.w),
                          ...
                          Align(
                            ...
                            child: Container(
                              padding:
                                  EdgeInsets.only(top: 210.80.h, left: 25.78.w),
                              child: Text(
                                '5h 21m',
                                style: TextStyle(
                                  fontSize: 9.02.sp,
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.only(left: 12.w, bottom: 70.h),
                              child: Container(
                                width: 50.22.w,
                                height: 17.61.h,
                                decoration: BoxDecoration(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.only(left: 70.w, bottom: 70.h),
                              child: Container(
                                width: 33.22.w,
                                height: 17.61.h,
                                decoration: BoxDecoration(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.only(left: 10.w, bottom: 70.h),
                              child: Container(
                                width: 27.22.w,
                                height: 17.61.h,
                                decoration: BoxDecoration(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.only(left: 60.w, bottom: 30.h),
                              child: Text(
                                nameTexts[index],
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.only(left: 60.w, bottom: 15.h),
                              child: Text(
                          ...
                          Align(
                            ...
                            child: Container(
                              padding:
                                  EdgeInsets.only(left: 10.78.w, bottom: 18.h),
                              child: ClipOval(
                                child: Image.network(
