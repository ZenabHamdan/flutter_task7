...
import 'package:task7/widgets/image_carousel.dart';
          ...
          flexibleSpace: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(top: 31.14.h),
                  child: Transform.translate(
                    offset: Offset(-10.w, 0),
                    child: SvgPicture.asset(AppImages.greenIcon),
                  ),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
      ...
      body: Column(
        children: [
          ...
          ImageSliderWidget(
            ...
            descriptionTexts:
                DescriptionText.descriptionTexts,
